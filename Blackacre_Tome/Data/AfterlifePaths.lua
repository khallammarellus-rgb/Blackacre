...
Blackacre.AfterlifePaths = {
    ...
    },
    {
        ...
        tasks = {
            ...
            { id = "queen", title = "Dream under the Queen", body = "Rest — truly rest Blackacre — before demanding the road back." },
...
function Blackacre.GetAfterlifePath(pathId)
    for _, path in ipairs(Blackacre.AfterlifePaths) do
