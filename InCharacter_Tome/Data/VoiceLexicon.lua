...
InCharacter.VoiceLexicon.undead = {
    label = "Forsaken",
    rules = {
...
InCharacter.VoiceLexicon.goblin = {
    label = "Goblin",
    rules = {
        { "friend", "partner" },
        { "friends", "partners" },
...
InCharacter.VoiceLexicon.blood_elf = {
    label = "Sin'dorei",
    rules = {
        { "magic", "the arcane" },
        { "mage", "magister" },
...
InCharacter.VoiceLexicon.night_elf = {
    label = "Kaldorei",
    rules = {
        { "hello", "elune-adore" },
...
InCharacter.VoiceLexicon.tauren = {
    label = "Shu'halo",
    rules = {
...
InCharacter.VoiceLexicon.draenei = {
    label = "Draenei",
    rules = {
        { "hello", "dichromi" },
        { "light", "the Light" },
...
InCharacter.VoiceLexicon.pandaren = {
    label = "Pandaren",
    rules = {
        { "hello", "hao" },
        { "friend", "brew-friend" },
...
InCharacter.VoiceLexicon.vulpera = {
    label = "Vulpera",
    rules = {
        { "cart", "caravan" },
        { "home", "the caravan" },
...
InCharacter.VoiceLexicon.human = {
...
InCharacter.VoiceLexicon.afrikaans = {
