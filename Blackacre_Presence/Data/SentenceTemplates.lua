...
function Blackacre.SentenceTemplates.GetTemplates()
    return templates
end

function Blackacre.SentenceTemplates.GetSlotOptions(slotName)
...
function Blackacre.SentenceTemplates.Resolve(templateId, slotValues, locationOverride)
