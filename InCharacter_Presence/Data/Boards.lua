...
function InCharacter.Boards.GetByRegion(region)
    local list = {}
    for _, board in ipairs(boards) do
...
function InCharacter.Boards.GetKnownListText()
    local lines = {}
    local seen = {}
    for _, board in ipairs(boards) do
...
function InCharacter.Boards.GetBoardsInZone(zoneId)
    local list = {}
    zoneId = zoneId or (InCharacter.GetZoneContext().zoneId)
    for _, board in ipairs(boards) do
